...
const Dashboard = () => {
  ...
  const [userAccount, setUserAccount] = useState<UserAccount>({
    balance: 0,
    cvu: '', // Inicializar como cadena vacía
    alias: '', // Inicializar como cadena vacía
    userId: 0, // Inicializar como cero
    id: 0, // Inicializar como cero
    name: ''
  });
          ...
          <div className="tw-flex tw-justify-between tw-mb-8">
            <div>
              ...
              <p className="tw-text-xl tw-font-bold">
                {userAccount && userAccount.balance !== undefined
